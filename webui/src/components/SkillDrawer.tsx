...
export const SkillDrawer: React.FC<{
  ...
  return (
    <div className="fixed inset-0 z-20 flex cursor-pointer justify-end" style={{ background: 'var(--scrim)' }} onClick={onClose}>
      <aside
        className="flex h-full w-[392px] max-w-[88vw] cursor-default flex-col overflow-y-auto border-l border-[var(--border)] bg-[var(--elev)] transition-transform duration-300 ease-out"
